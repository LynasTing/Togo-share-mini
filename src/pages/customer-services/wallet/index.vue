...
// 跳购买押金
const goPayDeposit = () => {
  uni.navigateTo({ url: '/pages/customer-services/wallet/deposit-pay/index' })
}
// 跳我的押金
const goMine = () => {
  uni.navigateTo({ url: '/pages/customer-services/wallet/my-deposit/index' })
}
// 交易明细
const goRecord = () => {
...
<template>
  <view class="wallet-page">
    ...
    <view class="brown-card flex-row-sb-c" @click="goPayDeposit">
      <view>支付押金</view>
      <view class="iconfont icon-youjiantou"></view>
    </view>
    <view class="brown-card flex-row-sb-c" @click="goMine">
      <view>我的押金</view>
      <view class="flex--c">
        <view>共3000.00元</view>
        <view class="iconfont icon-youjiantou" ></view>
